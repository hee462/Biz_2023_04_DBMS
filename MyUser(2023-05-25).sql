...
Table 에 PK를 임의의 일련번호로 설정을 했을 경우
데이터를 insert 할때 마다 새로운 일련번호를 생성하여 값을 추가해야 한다

DBMS 엔진에 따라 insert를 할때 자동으로 일련번호를 생성하는 기능이 있는데
오라클에는 없다(11 이하 버전), 오라클도 12이상에서는 자동생성하는 기능이 있는데
다른 DBMS 비하여 상당히 불편하다
...
VALUES(sql_accList.NEXTVAL,'20230582401','2023-05-24','11:10:00','1',10000,0);

SELECT * FROM tbl_accList;

UPDATE tbl_acc
SET acbanlance ='10000'
WHERE acNum ='2023052401';
